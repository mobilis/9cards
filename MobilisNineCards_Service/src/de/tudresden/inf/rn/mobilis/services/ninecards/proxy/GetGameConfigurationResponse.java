...
public class GetGameConfigurationResponse extends XMPPBean {
	...
	public GetGameConfigurationResponse(String muc, int maxRounds,
			int maxPlayers) {
		super();
		this.muc = muc;
	...
	public String payloadToXML() {
		...
		sb.append("<muc>").append(this.muc).append("</muc>");

		sb.append("<maxRounds>").append(this.maxRounds).append("</maxRounds>");

		sb.append("<maxPlayers>").append(this.maxPlayers)
				.append("</maxPlayers>");
