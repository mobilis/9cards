...
import de.tu_dresden.inf.rn.mobilis.services.ninecards.proxy.IMobilisNineCardsOutgoing;
import de.tu_dresden.inf.rn.mobilis.services.ninecards.proxy.MobilisNineCardsProxy;
...
public class IqConnection implements PacketListener
{
	...
	{
		return mServiceInstance.getAgent().getConnection() != null && mServiceInstance.getAgent().getConnection().isConnected();
	}
